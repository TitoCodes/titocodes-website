    ...
    <section class="hero is-fluid is-fullheight">
      <div class="hero-body">
        <div class="container">
          ...
          <div class="subtitle is-size-5">
             <span class="icon has-facebook-color">
  ...
  metaInfo: function () {
    return {
      ...
      meta: [
        ...
        { itemprop: 'name', content: `Home Page - ${this.$website_name}` },
        { itemprop: 'description', content: homeDescription },
        {
          itemprop: 'image',
          content: imagePath,
        },
